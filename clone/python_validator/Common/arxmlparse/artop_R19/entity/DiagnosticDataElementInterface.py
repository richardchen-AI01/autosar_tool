...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DiagnosticDataElementInterface.py
from .DiagnosticAbstractDataIdentifierInterface import DiagnosticAbstractDataIdentifierInterface

class DiagnosticDataElementInterface(DiagnosticAbstractDataIdentifierInterface):
