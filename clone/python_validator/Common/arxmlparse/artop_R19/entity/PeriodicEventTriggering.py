...
# Embedded file name: Common\arxmlparse\artop_R19\entity\PeriodicEventTriggering.py
...
class PeriodicEventTriggering(EventTriggeringConstraint):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_minimumInterArrivalTime':"MULTIDIMENSIONAL-TIME", 
