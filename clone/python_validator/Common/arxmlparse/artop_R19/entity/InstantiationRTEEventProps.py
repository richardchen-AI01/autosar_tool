...
# Embedded file name: Common\arxmlparse\artop_R19\entity\InstantiationRTEEventProps.py
...
class InstantiationRTEEventProps(ARObject):
    ...
    def __init__(self):
        ...
        from .InstanceEventInCompositionInstanceRef import InstanceEventInCompositionInstanceRef
        from .VariationPoint import VariationPoint
        self._artop_shortLabel = None
        self._artop_compositionSwComponentType = None
        self._artop_refinedEventIref = None
        self._artop_variationPoint = None
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_compositionSwComponentType':"COMPOSITION-SW-COMPONENT-TYPE", 
         '_artop_refinedEventIref':"INSTANCE-EVENT-IN-COMPOSITION-INSTANCE-REF-IREF", 
    ...
    @property
    def ref_refinedEvent_(self):
        return self._artop_refinedEventIref

    @property
    def refinedEvent_(self):
        if self._artop_refinedEventIref is not None:
            if hasattr(self._artop_refinedEventIref, "uuid"):
                return self._artop_refinedEventIref.uuid
        return
