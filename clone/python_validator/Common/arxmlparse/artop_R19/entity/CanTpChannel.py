...
# Embedded file name: Common\arxmlparse\artop_R19\entity\CanTpChannel.py
...
class CanTpChannel(Identifiable):
    ...
    def __init__(self):
        ...
        self._artop_channelId = None
        self._artop_channelMode = None
    ...
    @property
    def channelId_(self):
        return self._artop_channelId

    @property
    def channelMode_(self):
        return self._artop_channelMode
