...
# Embedded file name: Common\arxmlparse\artop_R19\entity\End2EndMethodProtectionProps.py
from .ARObject import ARObject

class End2EndMethodProtectionProps(ARObject):
    ...
    def __init__(self):
        ...
        self._tag_to_attr.update({'_artop_adaptivePlatformServiceInstance':"ADAPTIVE-PLATFORM-SERVICE-INSTANCE", 
         ...
         '_artop_methodRef':"SERVICE-METHOD-DEPLOYMENT"})
