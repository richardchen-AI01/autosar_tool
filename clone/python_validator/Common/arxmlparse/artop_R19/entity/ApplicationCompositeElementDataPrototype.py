...
# Embedded file name: Common\arxmlparse\artop_R19\entity\ApplicationCompositeElementDataPrototype.py
...
class ApplicationCompositeElementDataPrototype(DataPrototype):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_typeTref": "APPLICATION-DATA-TYPE"})
