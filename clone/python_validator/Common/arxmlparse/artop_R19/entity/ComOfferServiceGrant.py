...
# Embedded file name: Common\arxmlparse\artop_R19\entity\ComOfferServiceGrant.py
from .Grant import Grant

class ComOfferServiceGrant(Grant):

    def __init__(self):
        super().__init__()
        from .ComOfferServiceGrantDesign import ComOfferServiceGrantDesign
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_designRef':"COM-OFFER-SERVICE-GRANT-DESIGN", 
