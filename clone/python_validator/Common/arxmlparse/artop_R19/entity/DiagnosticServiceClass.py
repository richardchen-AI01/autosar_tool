...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DiagnosticServiceClass.py
...
class DiagnosticServiceClass(DiagnosticCommonElement):
    ...
    def __init__(self):
        ...
        self._artop_accessPermissionValidity = None
    ...
    @property
    def accessPermissionValidity_(self):
        return self._artop_accessPermissionValidity
