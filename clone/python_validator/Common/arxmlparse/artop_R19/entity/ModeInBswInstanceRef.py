...
# Embedded file name: Common\arxmlparse\artop_R19\entity\ModeInBswInstanceRef.py
...
class ModeInBswInstanceRef(ModeInSwcBswInstanceRef):
    ...
    def __init__(self):
        ...
        self._artop_contextBswImplementationRef = None
        self._artop_contextModeDeclarationGroupPrototypeRef = None
        self._artop_targetModeDeclarationRef = None
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_contextBswImplementationRef':"BSW-IMPLEMENTATION", 
    ...
    @property
    def ref_contextBswImplementation_(self):
        return self._artop_contextBswImplementationRef

    @property
    def contextBswImplementation_(self):
        if self._artop_contextBswImplementationRef is not None:
            if hasattr(self._artop_contextBswImplementationRef, "uuid"):
                return self._artop_contextBswImplementationRef.uuid
        return
