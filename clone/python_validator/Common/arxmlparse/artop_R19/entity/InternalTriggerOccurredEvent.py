...
# Embedded file name: Common\arxmlparse\artop_R19\entity\InternalTriggerOccurredEvent.py
...
class InternalTriggerOccurredEvent(RTEEvent):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_eventSourceRef": "INTERNAL-TRIGGERING-POINT"})
