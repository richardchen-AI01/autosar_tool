...
# Embedded file name: Common\arxmlparse\artop_R19\entity\CryptoServicePrimitive.py
...
class CryptoServicePrimitive(ARElement):
    ...
    def __init__(self):
        ...
        self._artop_algorithmSecondaryFamily = None
    ...
    @property
    def algorithmSecondaryFamily_(self):
        return self._artop_algorithmSecondaryFamily
