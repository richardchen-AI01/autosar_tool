...
# Embedded file name: Common\arxmlparse\artop_R19\entity\FunctionGroupModeRequestPhmActionItem.py
from .PhmActionItem import PhmActionItem

class FunctionGroupModeRequestPhmActionItem(PhmActionItem):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_requestedModeIref": "MODE-IN-MACHINE-INSTANCE-REF-IREF"})
