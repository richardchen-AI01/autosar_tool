...
# Embedded file name: Common\arxmlparse\artop_R19\entity\BswInternalTriggerOccurredEvent.py
...
class BswInternalTriggerOccurredEvent(BswScheduleEvent):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_eventSourceRef": "BSW-INTERNAL-TRIGGERING-POINT"})
