...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DiagnosticDataElement.py
...
class DiagnosticDataElement(Identifiable):
    ...
    def __init__(self):
        ...
        self._artop_scalingInfoSize = None
    ...
    @property
    def scalingInfoSize_(self):
        return self._artop_scalingInfoSize
