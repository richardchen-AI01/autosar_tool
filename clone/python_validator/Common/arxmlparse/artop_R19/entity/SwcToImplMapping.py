...
# Embedded file name: Common\arxmlparse\artop_R19\entity\SwcToImplMapping.py
...
class SwcToImplMapping(Identifiable):
    ...
    def __init__(self):
        ...
        self._artop_componentImplementationRef = None
        ...
        self._tag_to_attr.update({
         ...
         '_artop_componentImplementationRef': '"SWC-IMPLEMENTATION"', 
    ...
    @property
    def ref_componentImplementation_(self):
        return self._artop_componentImplementationRef

    @property
    def componentImplementation_(self):
        if self._artop_componentImplementationRef is not None:
            if hasattr(self._artop_componentImplementationRef, "uuid"):
                return self._artop_componentImplementationRef.uuid
        return
