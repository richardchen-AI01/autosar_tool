...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DiagnosticEventPortMapping.py
...
class DiagnosticEventPortMapping(DiagnosticSwMapping):
    ...
    def __init__(self):
        ...
        self._artop_bswServiceDependencyRef = None
        ...
        self._tag_to_attr.update({
         '_artop_bswServiceDependencyRef': '"BSW-SERVICE-DEPENDENCY-IDENT"', 
    ...
    def ref_bswServiceDependency_(self):
        return self._artop_bswServiceDependencyRef

    @property
    def bswServiceDependency_(self):
        if self._artop_bswServiceDependencyRef is not None:
            if hasattr(self._artop_bswServiceDependencyRef, "uuid"):
                return self._artop_bswServiceDependencyRef.uuid
        return
