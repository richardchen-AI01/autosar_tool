...
# Embedded file name: Common\arxmlparse\artop_R19\entity\InnerRunnableEntityGroupInCompositionInstanceRef.py
...
class InnerRunnableEntityGroupInCompositionInstanceRef(AtpInstanceRef):
    ...
    def __init__(self):
        ...
        self._artop_runnableEntityGroup = None
        self._artop_compositionSwComponentType = None
        self._artop_contextSwComponentPrototypeRef = []
        self._artop_targetRunnableEntityGroupRef = None
        self._artop_variationPoint = None
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({
         '_artop_runnableEntityGroup': '"RUNNABLE-ENTITY-GROUP"', 
         ...
         '_artop_targetRunnableEntityGroupRef': '"RUNNABLE-ENTITY-GROUP"', 
         '_artop_variationPoint': '"VARIATION-POINT"'})

    @property
    def ref_runnableEntityGroup_(self):
        return self._artop_runnableEntityGroup

    @property
    def runnableEntityGroup_(self):
        if self._artop_runnableEntityGroup is not None:
            if hasattr(self._artop_runnableEntityGroup, "uuid"):
                return self._artop_runnableEntityGroup.uuid
        return
    ...
    @property
    def ref_targetRunnableEntityGroup_(self):
        return self._artop_targetRunnableEntityGroupRef

    @property
    def targetRunnableEntityGroup_(self):
        if self._artop_targetRunnableEntityGroupRef is not None:
            if hasattr(self._artop_targetRunnableEntityGroupRef, "uuid"):
                return self._artop_targetRunnableEntityGroupRef.uuid
        return
