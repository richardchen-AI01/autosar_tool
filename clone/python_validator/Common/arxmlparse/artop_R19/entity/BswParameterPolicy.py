...
# Embedded file name: Common\arxmlparse\artop_R19\entity\BswParameterPolicy.py
from .BswApiOptions import BswApiOptions

class BswParameterPolicy(BswApiOptions):
    ...
    def __init__(self):
        ...
        self._artop_perInstanceParameterRef = None
        self._artop_variationPoint = None
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_bswInternalBehavior':"BSW-INTERNAL-BEHAVIOR", 
         '_artop_perInstanceParameterRef':"PARAMETER-DATA-PROTOTYPE", 
    ...
    @property
    def ref_perInstanceParameter_(self):
        return self._artop_perInstanceParameterRef

    @property
    def perInstanceParameter_(self):
        if self._artop_perInstanceParameterRef is not None:
            if hasattr(self._artop_perInstanceParameterRef, "uuid"):
                return self._artop_perInstanceParameterRef.uuid
        return
