...
# Embedded file name: Common\arxmlparse\artop_R19\entity\ComFieldGrant.py
from .Grant import Grant

class ComFieldGrant(Grant):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_designRef':"COM-FIELD-GRANT-DESIGN", 
         '_artop_serviceDeploymentRef':"SERVICE-FIELD-DEPLOYMENT", 
