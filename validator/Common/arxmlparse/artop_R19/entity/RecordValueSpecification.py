...
# Embedded file name: Common\arxmlparse\artop_R19\entity\RecordValueSpecification.py
...
class RecordValueSpecification(CompositeValueSpecification):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_field": "VALUE-SPECIFICATION"})

    @property
    def fields_ValueSpecification(self):
