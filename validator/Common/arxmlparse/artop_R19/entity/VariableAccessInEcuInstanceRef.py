...
# Embedded file name: Common\arxmlparse\artop_R19\entity\VariableAccessInEcuInstanceRef.py
...
class VariableAccessInEcuInstanceRef(AtpInstanceRef):
    ...
    def __init__(self):
        ...
        self._artop_targetVariableAccessRef = None
        ...
        self._tag_to_attr.update({
         ...
         '_artop_targetVariableAccessRef': '"VARIABLE-ACCESS"'})
    ...
    @property
    def ref_targetVariableAccess_(self):
        return self._artop_targetVariableAccessRef

    @property
    def targetVariableAccess_(self):
        if self._artop_targetVariableAccessRef is not None:
            if hasattr(self._artop_targetVariableAccessRef, "uuid"):
                return self._artop_targetVariableAccessRef.uuid
        return
