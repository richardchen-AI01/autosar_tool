...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DataPrototypeInPortInterfaceRef.py
...
class DataPrototypeInPortInterfaceRef(DataPrototypeReference):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_dataPrototypeIref": "DATA-PROTOTYPE-IN-PORT-INTERFACE-INSTANCE-REF-IREF"})
