...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DiagnosticClearConditionPortMapping.py
from .DiagnosticSwMapping import DiagnosticSwMapping

class DiagnosticClearConditionPortMapping(DiagnosticSwMapping):
    ...
    def __init__(self):
        ...
        self._artop_clearConditionRef = None
    ...
    @property
    def ref_clearCondition_(self):
        return self._artop_clearConditionRef

    @property
    def clearCondition_(self):
        if self._artop_clearConditionRef is not None:
            if hasattr(self._artop_clearConditionRef, "uuid"):
                return self._artop_clearConditionRef.uuid
        return
