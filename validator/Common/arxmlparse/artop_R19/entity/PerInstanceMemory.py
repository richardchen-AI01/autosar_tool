...
# Embedded file name: Common\arxmlparse\artop_R19\entity\PerInstanceMemory.py
...
class PerInstanceMemory(AtpStructureElement):
    ...
    def __init__(self):
        ...
        self._artop_typeDefinition = None
    ...
    @property
    def typeDefinition_(self):
        return self._artop_typeDefinition
