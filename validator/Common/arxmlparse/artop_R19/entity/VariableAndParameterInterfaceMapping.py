...
# Embedded file name: Common\arxmlparse\artop_R19\entity\VariableAndParameterInterfaceMapping.py
...
class VariableAndParameterInterfaceMapping(PortInterfaceMapping):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_dataMapping": "DATA-PROTOTYPE-MAPPING"})

    @property
    def dataMappings_DataPrototypeMapping(self):
