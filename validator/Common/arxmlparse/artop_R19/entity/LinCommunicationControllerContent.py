...
# Embedded file name: Common\arxmlparse\artop_R19\entity\LinCommunicationControllerContent.py
from .CommunicationControllerContent import CommunicationControllerContent

class LinCommunicationControllerContent(CommunicationControllerContent):
