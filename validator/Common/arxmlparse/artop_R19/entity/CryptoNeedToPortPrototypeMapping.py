...
# Embedded file name: Common\arxmlparse\artop_R19\entity\CryptoNeedToPortPrototypeMapping.py
from .ARElement import ARElement

class CryptoNeedToPortPrototypeMapping(ARElement):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_portPrototypeRef": "PORT-PROTOTYPE"})
