...
# Embedded file name: Common\arxmlparse\artop_R19\entity\SdgPrimitiveAttributeWithVariation.py
from .AbstractVariationRestriction import AbstractVariationRestriction
from .SdgAbstractPrimitiveAttribute import SdgAbstractPrimitiveAttribute
