...
# Embedded file name: Common\arxmlparse\artop_R19\entity\HwElementRefConditional.py
from .ARObject import ARObject

class HwElementRefConditional(ARObject):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_hwElementRef':"HW-ELEMENT", 
