...
# Embedded file name: Common\arxmlparse\artop_R19\entity\TDEventModeDeclaration.py
...
class TDEventModeDeclaration(TDEventVfbPort):
    ...
    def __init__(self):
        ...
        self._artop_tdEventModeDeclarationType = None
    ...
    @property
    def tdEventModeDeclarationType_(self):
        return self._artop_tdEventModeDeclarationType
