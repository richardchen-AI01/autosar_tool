...
# Embedded file name: Common\arxmlparse\artop_R19\entity\EthernetPriorityRegeneration.py
...
class EthernetPriorityRegeneration(Referrable):
    ...
    def __init__(self):
        ...
        self._artop_ingressPriority = None
        self._artop_regeneratedPriority = None
    ...
    @property
    def ingressPriority_(self):
        return self._artop_ingressPriority

    @property
    def regeneratedPriority_(self):
        return self._artop_regeneratedPriority
