...
# Embedded file name: Common\arxmlparse\artop_R19\entity\TraceableText.py
from .Traceable import Traceable
from .Paginateable import Paginateable
from .Identifiable import Identifiable

class TraceableText(Identifiable, Paginateable, Traceable):
    ...
    @property
    def ref_text_(self):
        return self._artop_text

    @property
    def text_(self):
        if self._artop_text is not None:
            if hasattr(self._artop_text, "uuid"):
                return self._artop_text.uuid
        return
