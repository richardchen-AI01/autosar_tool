...
# Embedded file name: Common\arxmlparse\artop_R19\entity\ComEventGrant.py
from .Grant import Grant

class ComEventGrant(Grant):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_designRef':"COM-EVENT-GRANT-DESIGN", 
         '_artop_serviceDeploymentRef':"SERVICE-EVENT-DEPLOYMENT", 
