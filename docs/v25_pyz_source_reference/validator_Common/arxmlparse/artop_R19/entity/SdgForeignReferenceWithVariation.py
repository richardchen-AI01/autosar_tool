...
# Embedded file name: Common\arxmlparse\artop_R19\entity\SdgForeignReferenceWithVariation.py
from .AbstractVariationRestriction import AbstractVariationRestriction
from .SdgAbstractForeignReference import SdgAbstractForeignReference
