...
# Embedded file name: Common\arxmlparse\artop_R19\entity\ApplicationEndpointRefConditional.py
from .ARObject import ARObject

class ApplicationEndpointRefConditional(ARObject):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_applicationEndpointRef':"APPLICATION-ENDPOINT", 
