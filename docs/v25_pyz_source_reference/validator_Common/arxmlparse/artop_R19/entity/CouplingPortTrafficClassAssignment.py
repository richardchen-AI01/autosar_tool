...
# Embedded file name: Common\arxmlparse\artop_R19\entity\CouplingPortTrafficClassAssignment.py
...
class CouplingPortTrafficClassAssignment(Referrable):
    ...
    @property
    def trafficClass_(self):
        return self._artop_trafficClass
