...
# Embedded file name: Common\arxmlparse\artop_R19\entity\SynchronousServerCallPoint.py
...
class SynchronousServerCallPoint(ServerCallPoint):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_calledFromWithinExclusiveAreaRef": "EXCLUSIVE-AREA-NESTING-ORDER"})
