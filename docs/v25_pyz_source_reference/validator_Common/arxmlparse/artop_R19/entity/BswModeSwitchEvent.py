...
# Embedded file name: Common\arxmlparse\artop_R19\entity\BswModeSwitchEvent.py
...
class BswModeSwitchEvent(BswScheduleEvent):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({"_artop_modeIref": "MODE-IN-BSW-MODULE-DESCRIPTION-INSTANCE-REF-IREF"})
    ...
    @property
    def modes_ModeInBswModuleDescriptionInstanceRef(self):
