...
# Embedded file name: Common\arxmlparse\artop_R19\entity\UserDefinedFieldDeployment.py
from .ServiceFieldDeployment import ServiceFieldDeployment

class UserDefinedFieldDeployment(ServiceFieldDeployment):

    def __init__(self):
        super().__init__()
        from .UserDefinedMethodDeployment import UserDefinedMethodDeployment
        from .UserDefinedEventDeployment import UserDefinedEventDeployment
        self._artop_get = None
        self._artop_notifier = None
        self._artop_set = None
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_get':"USER-DEFINED-METHOD-DEPLOYMENT", 
         '_artop_notifier':"USER-DEFINED-EVENT-DEPLOYMENT", 
         '_artop_set':"USER-DEFINED-METHOD-DEPLOYMENT"})
