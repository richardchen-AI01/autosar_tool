...
# Embedded file name: Common\arxmlparse\artop_R19\entity\Xdoc.py
...
class Xdoc(SingleLanguageReferrable):
    ...
    def __init__(self):
        ...
        from .Url import Url
        self._artop_number = None
        self._artop_state = None
        self._artop_date = None
        self._artop_publisher = None
