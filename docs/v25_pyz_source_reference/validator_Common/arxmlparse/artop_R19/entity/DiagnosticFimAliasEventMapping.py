...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DiagnosticFimAliasEventMapping.py
...
class DiagnosticFimAliasEventMapping(DiagnosticMapping):
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_tag_to_attr"):
            self._tag_to_attr = {}
        self._tag_to_attr.update({'_artop_actualEventRef':"DIAGNOSTIC-EVENT", 
         '_artop_aliasEventRef':"DIAGNOSTIC-FIM-ALIAS-EVENT"})
