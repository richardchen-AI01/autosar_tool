...
# Embedded file name: Common\arxmlparse\artop_R19\entity\GlobalTimeCouplingPortProps.py
...
class GlobalTimeCouplingPortProps(ARObject):
    ...
    def __init__(self):
        ...
        self._artop_propagationDelay = None
    ...
    @property
    def propagationDelay_(self):
        return self._artop_propagationDelay
