...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DataPrototypeInServiceInterfaceInstanceRef.py
from .DataPrototypeInPortInterfaceInstanceRef import DataPrototypeInPortInterfaceInstanceRef

class DataPrototypeInServiceInterfaceInstanceRef(DataPrototypeInPortInterfaceInstanceRef):
    ...
    def __init__(self):
        ...
        self._tag_to_attr.update({
         ...
         '_artop_serviceInterface': '"SERVICE-INTERFACE"', 
