...
# Embedded file name: Common\arxmlparse\artop_R19\entity\DiagnosticDataChangeTrigger.py
from .DiagnosticResponseOnEventTrigger import DiagnosticResponseOnEventTrigger

class DiagnosticDataChangeTrigger(DiagnosticResponseOnEventTrigger):
