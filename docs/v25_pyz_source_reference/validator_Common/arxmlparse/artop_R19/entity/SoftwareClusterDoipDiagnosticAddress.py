...
# Embedded file name: Common\arxmlparse\artop_R19\entity\SoftwareClusterDoipDiagnosticAddress.py
from .SoftwareClusterDiagnosticAddress import SoftwareClusterDiagnosticAddress

class SoftwareClusterDoipDiagnosticAddress(SoftwareClusterDiagnosticAddress):
