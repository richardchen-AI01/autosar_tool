...
| **M3.1** 4 核心模块端到端跑通 | D11 | MemIf 5/5 + Det 5/5 + NvM 4/4 + Ea 优雅退出 | ✅ 提前 9 天 |
| **M3.2** 30 模块 smoke | D11 | 4 核心模块全通；其余按需扩展 | 进行中 |
| **M4.1** PyInstaller 打包 | D14 | macOS bswgen/bswval 已打包 OK | ✅ |

测试套件：`pytest core/tests/ generator/tests/ validator/tests/` — **25/25 PASS**
