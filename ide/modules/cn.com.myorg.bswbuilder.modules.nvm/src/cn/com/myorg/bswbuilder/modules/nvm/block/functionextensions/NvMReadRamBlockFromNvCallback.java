...
/**
 * Reference: cn.com.isoft.bswbuilder.nvm.block.functionextensions.NvMReadRamBlockFromNvCallback.
 */
public class NvMReadRamBlockFromNvCallback
    ...
    public Object calc(Object obj) {
        ...
        if (parent instanceof GContainer) {
            ...
            if (ramBlockService) {
                ...
                return "Rte_Call_PM_" + name + "_ReadRamBlockFromNvM";
            }
        }
        return null;
    }
