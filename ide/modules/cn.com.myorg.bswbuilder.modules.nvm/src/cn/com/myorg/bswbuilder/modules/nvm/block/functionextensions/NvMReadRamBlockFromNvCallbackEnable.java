...
/**
 * Reference: cn.com.isoft.bswbuilder.nvm.block.functionextensions.NvMReadRamBlockFromNvCallbackEnable.
 */
public class NvMReadRamBlockFromNvCallbackEnable extends ComputeEnableUIDefinition {

    @Override
    public String getDefElementName() {
        return "NvMReadRamBlockFromNvCallback";
    }
