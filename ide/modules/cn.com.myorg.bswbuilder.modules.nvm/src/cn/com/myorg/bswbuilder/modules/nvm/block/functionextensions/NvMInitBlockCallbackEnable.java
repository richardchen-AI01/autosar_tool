...
/**
 * Reference: cn.com.isoft.bswbuilder.nvm.block.functionextensions.NvMInitBlockCallbackEnable.
 */
public class NvMInitBlockCallbackEnable
        extends ComputeEnableUIDefinition
        implements IAutoComputeUIDefinition {

    @Override
    public String getDefElementName() {
        return "NvMInitBlockCallbackFnc";
    }
    ...
    public boolean compute(Object parentContainer) {
        ...
        try {
            initBlockCallbackObj = ModelUtils.getEObjectByPath("NvMInitBlockCallbackFnc", (EObject) parentContainer);
    ...
    public Object calc(Object obj) {
        ...
        if (parent instanceof GContainer) {
            ...
            if (rteModelExist && (value == null || value.trim().isEmpty())) {
                return "Rte_Call_NvM_PNIB_" + name + "_InitBlock";
            }
        }
        return null;
    }
